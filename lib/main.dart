...
در این سایت چه می‌کنید؟
چهار هدف اصلی‌تان را تعریف می‌کنید
برای هرکدام، ریزهدف‌هایی مشخص و قابل‌انجام در یک نشست می‌نویسید
هر بار که ریزهدفی را کامل کردید، آن را علامت می‌زنید
در تقویم روزانه، درباره مسیر و احساس‌تان یادداشت می‌گذارید
و پیشرفت کلی‌تان را — نه بر اساس زمان، بلکه بر اساس واقعاً چه‌کاری انجام داده‌اید — می‌بینید, style: TextStyle(color: AppColors.textSoft, height: 1.8)),
    ]);
  }
}
